        ...
        <div class="container">
                        ...
                        <div class="form-group">
                            <div class="row m-auto">
                                <div class="w-75 m-auto ">
                                    ...
                                    <textarea id="form7" name="description" placeholder="Enter Lesson Description" class="md-textarea form-control mt-4" rows="4"></textarea>
            ...
            <table class="table col-md-12 bg-white table-bordered table-striped table-bordered table-hover ">
                <thead>
                    ...
                    <th>Course Name</th>
                    <th>URL</th>
                    <th class='w-50'>Picture</th>
                    <th colspan='2'>Lesson Description</th>
                </thead>
                <tbody>
                    <?php
                    foreach ($upshot as $row) {
                        ...
                        echo "<td><img src='upload/$img' class='w-50'></td>";
                        echo "<td>" . $row['Les_Description'] . "</td>";
