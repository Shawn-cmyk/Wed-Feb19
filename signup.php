...
<body class="formback">
    ...
    <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
        <div class="container">
            ...
            <div data-toggle="tooltip" data-placement="bottom" title="Sign-Up">
                <a type="button" href="signup.php" class="btn btn-b-n text-white d-md-block mr-3 bg-dark " data-toggle="modal" data-target="#signup" data-whatever="@getbootstrap">
                    <span class="fas fa-file-signature"></span>
                </a>
            </div>
            <!--
            <a type="button" href="signup.php" class="btn btn-b-n text-white d-md-block mr-3 bg-dark " data-toggle="tooltip" data-placement="bottom" title="Sign-Up">
                <span class="fas fa-file-signature"></span>
            </a>-->
            <div data-toggle="tooltip" data-placement="bottom" title="Log-in">
                <button type="button" class="btn btn-b-n text-white d-md-block mr-3 bg-warning" data-toggle="modal" data-target="#login" data-whatever="@getbootstrap">
                    <span class="fas fa-sign-in-alt"></span></button>
            </div>

            <!--
            <a type="button" href="login.php" class="btn btn-b-n text-white d-md-block mr-3 bg-warning" data-toggle="tooltip" data-placement="bottom" title="Log In">
                <span class="fas fa-sign-in-alt"></span>
            </a> -->

            <div data-toggle="tooltip" data-placement="bottom" title="Search">
    ...
    <!--/ signup Start /-->
    <div class="modal fade rounded" id="signup" tabindex="-1" role="dialog" aria-labelledby="signup">
        <div class="modal-dialog" role="document">
            <div class="modal-content w-75 m-auto form-log-sign">
                <div class="card mx-auto form-shadow border-primary">
    ...
    <!--/ login Start /-->
    <div class="modal fade rounded" id="login" tabindex="-1" role="dialog" aria-labelledby="login">
        <div class="modal-dialog" role="document">
            <div class="modal-content w-75 m-auto form-log-sign ">
                <div class="card mx-auto form-shadow border-warning">
